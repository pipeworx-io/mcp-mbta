...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/mbta_departures \
  -H 'Content-Type: application/json' \
  -d '{"stop":"South Station","route":"Red"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/mbta_departures`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
